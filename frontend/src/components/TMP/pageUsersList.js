...
export default class UsersList extends Component {
    ...
    renderUser = (user) => {
        return <div className={'row table_row'}>
            <div className={'MDBCol-md-1'}>{user.id}</div>
            <div className={'MDBCol-md-5'}>{user.username}</div>
            <div className={'MDBCol-md-3'}>{this.russianRole(user.userRole)}</div>
            <div className={'MDBCol-md-3'}>{user.email}</div>
            <div className={'MDBCol-md-3'}><a href={`/user/${user.id}/edit`}>Изменить</a></div>
        </div>
    };
    ...
    render() {
        return <div className={'row'}>
            <div className="offset-md-1 MDBCol-md-6 superuserform_companylist">
                <div className="row table_header">
                    <div className="MDBCol-md-1">Id</div>
                    <div className="MDBCol-md-5">Никнейм</div>
                    <div className="MDBCol-md-3">Роль</div>
                    <div className="MDBCol-md-3">Почта</div>
                </div>
                {
            ...
            <div className="offset-md-1 MDBCol-md-3" id={'add-user-form'}>
                <form className="superuserform_newaccountform grey_form">
                    ...
                    <div id={'from-content'}>
                        ...
                        <div className="form-group">
                            <MDBLabel htmlFor="newUserEmail" id="emailLabel">Email</MDBLabel>
                            <MDBInput onChange={this.changeInput} type="email" className="form-control" id="newUserEmail"
                                   placeholder="newUser@gmail.com" required=""/>
                        </div>
                        <div className="form-group">
                            <MDBLabel htmlFor="newUserUsername" id="usernameLabel">Никнейм</MDBLabel>
                            <MDBInput onChange={this.changeInput} type="text" className="form-control" id="newUserUsername"
                                   placeholder="bestWorker2018" required=""/>
                        </div>
                        <div className="form-group">
                            <MDBLabel htmlFor="newUserDate" id="dateLabel">Дата рождения</MDBLabel>
                            <MDBInput onChange={this.changeInput} value={this.state.newUserDate} type="text"
                                   className="form-control" id="newUserDate"
                                   placeholder="01/01/2018" required=""/>
                        </div>
                        <div className="form-group">
                            <MDBLabel htmlFor="newUserRole" id="roleLabel">Роль</MDBLabel>
                        ...
                        <div className="form-group">
                            <MDBLabel htmlFor="newUserPassword" id="passwordLabel">Пароль</MDBLabel>
                            <MDBInput onChange={this.changeInput} type="password" className="form-control"
