...
class PageStockList extends React.Component {
    ...
    renderTable(stock){
        ...
        return <div className={"row table_row"}>
            <div className={"MDBCol-md-1"}>{stock.id}</div>
            <div className={"MDBCol-md-4"}>{stock.name}</div>
            <div className={"MDBCol-md-4"}>{stock.address}</div>
            <div className={"MDBCol-md-2"}>
       ...
       return <div className="row">
           <div className="offset-md-1 MDBCol-md-6 superuserform_companylist">
                   <div className="row table_header">
                       ...
                       <div className="MDBCol-md-5">Название склада</div>
                       <div className="MDBCol-md-4">Адрес</div>
                       <div className="MDBCol-md-1"></div>
                       <div className="MDBCol-md-1"></div>
                   </div>
                   {
           ...
           <div className="offset-md-1 MDBCol-md-3">
               <form className="superuserform_newaccountform grey_form">
                   <h5>Добавить склад</h5>
                   <div className="form-group">
                       <MDBInput value={this.state.stockName} onChange={this.setCompanyName} type="text" className="form-control" id="inputname" placeholder="Склад #201" required=""/>
                   </div>
                   <div className="form-group">
                       <MDBInput value={this.state.stockAddress} onChange={this.setCompanyAddress} type="text" className="form-control" id="inputstockadres" placeholder="Адрес" required=""/>
                   </div>
